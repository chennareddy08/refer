...
class HTMLReport(object):
    ...
    def _generate_report(self, session):
        ...
        cells = [
            html.th('Test Results',
                    class_='sortable result initial-sort',
                    col='Test Result'),
            html.th('Test Name', class_='sortable', col='Test Name'),
            html.th('Duration', class_='sortable numeric', col='Test duration'),
            html.th('Links', class_='sortable numeric', col='links')]


        session.config.hook.pytest_html_results_table_header(cells=cells)

        results = [html.h2('Test Results'), html.table([html.thead(
            html.tr(cells),
            html.tr([
        ...
        body = html.body(
            ...
            html.p('Report generated on {0} at {1} by '.format(
                ...
                html.a(os.environ.get('USERNAME').capitalize())),onLoad='init()')
        ...
        body.extend([html.h2('Test Auomation Summary')] + summary_prefix
    ...
    def _generate_environment(self, config):
        ...
        environment = [html.h2('Test Environment')]
        rows = []
